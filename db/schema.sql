...
-- Every run write asks "which students were flagged in the run with the largest
-- run_at?" - that lookup is what decides new vs. still_at_risk.
CREATE INDEX IF NOT EXISTS alerts_run_at_idx ON alerts (run_at);
